...
///
/// \if UNICODE
///   \sa TabStripCtlLibU::IOLEDataObject, TargetOLEDataObject, TabStrip,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \else
///   \sa TabStripCtlLibA::IOLEDataObject, TargetOLEDataObject, TabStrip,
///       <a href="https://msdn.microsoft.com/en-us/library/ms688421.aspx">IDataObject</a>
/// \endif
//////////////////////////////////////////////////////////////////////
...
class ATL_NO_VTABLE SourceOLEDataObject : 
    ...
    #ifdef UNICODE
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_TabStripCtlLibU, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #else
    	public IDispatchImpl<IOLEDataObject, &IID_IOLEDataObject, &LIBID_TabStripCtlLibA, /*wMajor =*/ VERSION_MAJOR, /*wMinor =*/ VERSION_MINOR>,
    #endif
    public IDataObject,
...
public:
	...
	///
	/// \if UNICODE
	///   \sa SetDropDescription, TabStrip::get_SupportOLEDragImages,
	...
	/// \else
	///   \sa SetDropDescription, TabStrip::get_SupportOLEDragImages,
	///       TabStripCtlLibA::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \endif
	...
	///            Windows&reg; SDK are valid.
	///
	/// \sa GetData, Clear, TabStrip::Raise_OLESetData,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms649049.aspx">RegisterClipboardFormat</a>,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms682177.aspx">FORMATETC</a>,
	///     <a href="https://msdn.microsoft.com/en-us/library/bb776902.aspx#CFSTR_FILECONTENTS">CFSTR_FILECONTENTS</a>,
	///     <a href="https://msdn.microsoft.com/en-us/library/ms690318.aspx">DVASPECT</a>
	...
	///
	/// \if UNICODE
	///   \sa GetDropDescription, TabStrip::put_SupportOLEDragImages,
	///       TabStripCtlLibU::DropDescriptionIconConstants,
	///       <a href="https://msdn.microsoft.com/en-us/library/bb773268.aspx">DROPDESCRIPTION</a>
	/// \else
	///   \sa GetDropDescription, TabStrip::put_SupportOLEDragImages,
...
protected:
	...
	struct Properties
	{
		/// \brief <em>The \c TabStrip object that owns this object</em>
		///
		/// \sa SetOwner
